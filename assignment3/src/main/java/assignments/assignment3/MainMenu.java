...
// *Diganti dengan copy directory assignment2 ke assignment3
...
public class MainMenu {
    ...
    public static void addRestoList(Restaurant resto) { // Adder
        MainMenu.restoList.add(resto);
    }
    public static void removeRestoList(Restaurant resto) { // Remover
        MainMenu.restoList.remove(resto);
    }
    ...
    public void run() {
        ...
        System.out.println("Terima kasih telah menggunakan DepeFood!"); // Menambahkan pesan terima kasih
        input.close();
    }
    ...
    private void login() {
        ...
        // Menjalankan sistem berdasarkan role user
